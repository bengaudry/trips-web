...
export function NavBar() {
  ...
  return (
    <nav className="fixed bottom-0 z-30 w-screen bg-neutral-100/60 dark:bg-grayblue-800/60 backdrop-blur-md py-3 pb-10 border-t border-neutral-200 dark:border-grayblue-600 lg:w-72 lg:fixed lg:h-screen lg:top-0 lg:left-0">
