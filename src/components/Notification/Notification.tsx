...
export function Notification(props: {
  ...
  return (
    <div
      className={`fixed z-50 top-4 left-4 right-4 ${
        props.type === "error"
          ? "bg-red-600/60"
          : props.type === "success"
          ? "bg-green-600/60"
          : "bg-yellow-600/60"
      } backdrop-blur-md w-[calc(100vw-2rem)] px-6 py-3 rounded-xl flex flex-row items-center justify-between gap-4 transition-transform duration-500 ${
