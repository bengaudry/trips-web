          ...
          <button
            ...
            className={`grid place-content-center py-6 border-2 rounded-lg transition-colors text-black dark:text-white ${
              selectedOptions.includes(index)
                ? "border-black hover:bg-neutral-100 dark:border-brand-500 dark:hover:bg-brand-500/10 dark:bg-brand-500/10"
                : "border-neutral-100 hover:bg-neutral-100 dark:border-grayblue-800 dark:hover:bg-grayblue-800"
            }`}
