...
export function SlidingPage(props: {
  ...
  return (
    <div
      ...
      } z-40 fixed right-0 top-0 w-full lg:w-[calc(100vw-18rem)] h-screen bg-white dark:bg-grayblue-900 bg-gradient-to-br from-orange-700 to-green-600 transition-transform duration-500 overflow-y-scroll ${
